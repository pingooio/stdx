...
pub const URL_SAFE: Alphabet =
    Alphabet::from_str_unchecked("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_");

/// The `crypt(3)` alphabet (with `.` and `/` as the _first_ two characters).
///
/// Not standardized, but folk wisdom on the net asserts that this alphabet is what crypt uses.
pub const CRYPT: Alphabet =
    Alphabet::from_str_unchecked("./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz");
...
pub const BIN_HEX: Alphabet =
    Alphabet::from_str_unchecked("!\"#$%&'()*+,-012345689@ABCDEFGHIJKLMNPQRSTUVXYZ[`abcdefhijklmpqr");
...
mod tests {
    ...
    fn detects_duplicate_start() {
        assert_eq!(
            ...
            Alphabet::new("AACDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").unwrap_err()
        );
    }
    ...
    fn detects_duplicate_end() {
        assert_eq!(
            ...
            Alphabet::new("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789//").unwrap_err()
        );
    }
    ...
    fn detects_duplicate_middle() {
        assert_eq!(
            ...
            Alphabet::new("ABCDEFGHIJKLMNOPQRSTUVWXYZZbcdefghijklmnopqrstuvwxyz0123456789+/").unwrap_err()
        );
    }
    ...
    fn detects_length() {
        assert_eq!(
            ...
            Alphabet::new("xxxxxxxxxABCDEFGHIJKLMNOPQRSTUVWXYZZbcdefghijklmnopqrstuvwxyz0123456789+/",).unwrap_err()
        );
    }
    ...
    fn detects_unprintable() {
        ...
        assert_eq!(
            ...
            Alphabet::new("\x0cBCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").unwrap_err()
        );
    }
