...
pub enum Alphabet {
    ...
    Standard,
    /// The standard base64 alphabet without padding, as defined in RFC 4648 section 3.2.
    StandardNoPadding,
    /// The base64 alphabet with URL and Filename Safe Alphabet, as defined in RFC 4648 section 5
    Url,
    /// The base64 alphabet with URL and Filename Safe Alphabet without padding, as defined in RFC 4648 section 5
    UrlNoPadding,
}

/// encodes input with the standard base64 alphabet, as defined in RFC 4648.
pub fn encode(input: &[u8]) -> String {
    return encode_with_alphabet(input, Alphabet::Standard);
}

/// encodes input with the standard base64 alphabet, as defined in RFC 4648.
pub fn encode_with_alphabet(input: &[u8], alphabet: Alphabet) -> String {
    match alphabet {
        Alphabet::Standard => engine::general_purpose::STANDARD.encode(input),
        Alphabet::StandardNoPadding => engine::general_purpose::STANDARD_NO_PAD.encode(input),
        Alphabet::Url => engine::general_purpose::URL_SAFE.encode(input),
        Alphabet::UrlNoPadding => engine::general_purpose::URL_SAFE_NO_PAD.encode(input),
    }
}
...
/// decodes input with the standard base64 alphabet, as defined in RFC 4648.
pub fn decode_with_alphabet(input: &[u8], alphabet: Alphabet) -> Result<Vec<u8>, DecodeError> {
    match alphabet {
        Alphabet::Standard => engine::general_purpose::STANDARD.decode(input),
        Alphabet::StandardNoPadding => engine::general_purpose::STANDARD_NO_PAD.decode(input),
        Alphabet::Url => engine::general_purpose::URL_SAFE.decode(input),
        Alphabet::UrlNoPadding => engine::general_purpose::URL_SAFE_NO_PAD.decode(input),
    }
}
