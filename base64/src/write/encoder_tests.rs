...
fn encode_nine_bytes_two_writes() {
    ...
    assert_eq!(&c.get_ref()[..], URL_SAFE_ENGINE.encode("abcdefghi").as_bytes());
}
...
fn encode_one_then_five_bytes() {
    ...
    assert_eq!(&c.get_ref()[..], URL_SAFE_ENGINE.encode("abcdef").as_bytes());
}
...
fn encode_with_padding_multiple_writes() {
    ...
    assert_eq!(&c.get_ref()[..], URL_SAFE_ENGINE.encode("abcdefg").as_bytes());
}
