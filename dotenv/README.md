# dotenv ![CI](https://github.com/pingooio/stdx/dotenv/workflows/CI/badge.svg) [![Go Report Card](https://goreportcard.com/badge/github.com/pingooio/stdx/dotenv)](https://goreportcard.com/report/github.com/pingooio/stdx/dotenv)
...
If you need to, you can also use `dotenv.Overload()` to defy this convention
...
This library has been declared feature complete (see [#182](https://github.com/pingooio/stdx/dotenv/issues/182) for background) and will not be accepting issues or pull requests adding new functionality or breaking the library API.
...
Use [annotated tags for all releases](https://github.com/pingooio/stdx/dotenv/issues/30). Example `git tag -a v1.2.1`
