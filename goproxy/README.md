...
[![GoDoc](https://godoc.org/github.com/pingooio/stdx/goproxy?status.svg)](https://godoc.org/github.com/pingooio/stdx/goproxy)
...
![Status](https://github.com/pingooio/stdx/goproxy/workflows/Go/badge.svg)
...
import (
    "github.com/pingooio/stdx/goproxy"
    "log"
    "net/http"
)
...
[the eavesdropper example](https://github.com/pingooio/stdx/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/pingooio/stdx/goproxy/tree/master/examples/goproxy-transparent)
