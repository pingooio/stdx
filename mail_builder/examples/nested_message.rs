                            ...
                            vec![
                                MimePart::new(
                                    ...
                                    vec![
                                        ...
                                        MimePart::new("image/jpeg", "Part C contents go here...".as_bytes()).inline(),
                                ...
                                MimePart::new(
                                    ...
                                    vec![
                                        ...
                                        MimePart::new("image/jpeg", "Part F contents go here...".as_bytes()),
                                    ],
                                ),
                            ],
                        ),
                        MimePart::new("image/jpeg", "Part G contents go here...".as_bytes()).attachment("image_G.jpg"),
                        MimePart::new("application/x-excel", "Part H contents go here...".as_bytes()),
