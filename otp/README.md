...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/pingooio/stdx/otp)](https://pkg.go.dev/github.com/pingooio/stdx/otp) [![Build Status](https://travis-ci.org/pquerna/otp.svg?branch=master)](https://travis-ci.org/pquerna/otp)
...
Please [open issues in Github](https://github.com/pingooio/stdx/otp/issues) for ideas, bugs, and general thoughts.  Pull requests are of course preferred :)
