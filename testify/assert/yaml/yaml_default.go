...
// [github.com/pingooio/stdx/yaml] (for example for license compatibility reasons, see [PR #1120]).
//
...
// Unmarshal is just a wrapper of [github.com/pingooio/stdx/yaml.Unmarshal].
