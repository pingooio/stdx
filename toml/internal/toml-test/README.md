...
work):
    ...
    $ git clone https://github.com/pingooio/stdx/toml-test.git
    $ cd toml-test
    $ go build ./cmd/toml-test

This will build a `./toml-test` binary.

[r]: https://github.com/pingooio/stdx/toml-test/releases
...
For example, to run the tests against the Go TOML library:
    ...
    # Install my parser
    $ go install github.com/pingooio/stdx/toml/cmd/toml-test-decoder@master
    $ go install github.com/pingooio/stdx/toml/cmd/toml-test-encoder@master
...
- [Add tags](https://github.com/pingooio/stdx/toml/blob/master/internal/tag/add.go)
- [Remove tags](https://github.com/pingooio/stdx/toml/blob/master/internal/tag/rm.go)
...
- When testing encoders, the TOML decoder at
  [github.com/pingooio/stdx/toml/toml](https://github.com/pingooio/stdx/toml) is assumed to be
