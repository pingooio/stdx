...
import (
	...
	"github.com/pingooio/stdx/toml"
	"github.com/pingooio/stdx/toml/internal/tag"
	tomltest "github.com/pingooio/stdx/toml/internal/toml-test"
)
	...
	run := func(t *testing.T, enc bool) {
		r := tomltest.Runner{
			...
			SkipTests: []string{
				...
				// https://github.com/pingooio/stdx/toml/issues/320
